...
# This scope allows read/write access to Gmail, including deleting messages.
SCOPES = ['https://mail.google.com/']

def authenticate():
    creds = None
    # Delete the token.json file if it exists to force re-authentication with new scopes.
